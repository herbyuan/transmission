...
- (instancetype)init
{
    if ((self = [super init]))
    {
        ...
        tr_variantDictAddBool(&settings, TR_KEY_rpc_ssl_cert, [_fDefaults stringForKey:@"RPCSSLCert"].UTF8String);
        tr_variantDictAddBool(&settings, TR_KEY_rpc_ssl_key, [_fDefaults stringForKey:@"RPCSSLKey"].UTF8String);
