...
std::array<Prefs::PrefItem, Prefs::PREFS_COUNT> const Prefs::Items{
    ...
    { RPC_SSL_CERT, TR_KEY_rpc_ssl_cert, QMetaType::QString },
    { RPC_SSL_ENABLED, TR_KEY_rpc_ssl_enabled, QMetaType::Bool },
    { RPC_SSL_KEY, TR_KEY_rpc_ssl_key, QMetaType::QString },
